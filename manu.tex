...
\begin{figure*}[!t]
\centering
\subfloat[Absolute of contribution of peer.\label{fig:contribu-normal}]{
\includegraphics[width=5.7cm]{graphs/new/repl/contributioncdnpeermodelsortedabs.png}
}
\hfill
\vspace{2mm}
\subfloat[Absolute contribution of peers with zipf popularity.\label{fig:contrib-zipf}]{
...
\begin{figure*}[!t]
\centering
\subfloat[Frequency a video in peers.\label{fig:freq-normal}]{
\includegraphics[width=5.7cm]{graphs/new/repl/freq.png}
}
\hfill
\vspace{2mm}
\subfloat[Frequency a video in peers with zipf popularity.\label{fig:freq-zipf}]{
...
\begin{figure*}[!t]
\centering
\subfloat[Cache duration in peers.\label{fig:duration-normal}]{
\includegraphics[width=5.7cm]{graphs/new/repl/duration.png}
}
\hfill
\vspace{2mm}
\subfloat[Cache duration in peers with zipf popularity.\label{fig:duration-zipf}]{
...
\begin{figure*}[!t]
\centering
\subfloat[Number of a video replicas when a peer request a video.\label{fig:atd-normal}]{
\includegraphics[width=5.7cm]{graphs/new/repl/atd.png}
}
\hfill
\vspace{2mm}
\subfloat[Number of a video replicas when a peer request a video with zipf popularity.\label{fig:atd-zipf}]{
\includegraphics[width=5.7cm]{graphs/new/zipf/duration.png}
}
