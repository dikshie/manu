...
Linear addition of $z$ factor here can help to differentiate the value of utility function.
...
Since $p_{min}$ and $p_{max}$ are same, we can arrange the equation become:
