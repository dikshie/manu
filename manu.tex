...
%Different topologies have been proposed in the literature, such as those where the collaborative mechanism for content distribution is created among more stable devices such as residential gateways.  
...
\begin{itemize} 
\item We use three phases of Youtube popularity in simulation. (idea)
\item We run simulation over long time to explore the behavior of the system. (hasil)
\end{itemize}
