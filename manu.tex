...
\end{center}
\caption{view rate distribution example. }
...
\end{center}
\caption{graph of view rate distributio and red}
...
In fig.~\ref{fig:viewratedistexample}, we have view rate (y-axis) and relative week to peak (x-axis) which is view rate distribution versus week relative to at-peak phase as also shown completely in fig.~\ref{fig:viewratedistribution}.
We transform these numbers by adding number of week and make number of week as x-axis, view rate 
as y-axis, and relative week to peak as z-axis.
This transformation is shown in fig.~\ref{fig:viewratedistexamplered} as blue dot.
Assume there is a video in week 3 with view rate vr$=2$ as shown in fig.~\ref{fig:viewratedistexamplered} as red dot.
We want to estimate what is the position of that video. 
Is the video in at-peak phase, before-phase, or after phase.  
We can estimate the that video position by averaging relative week to peak numbers (z-axis) of the nearest point from datasets. 
...
By averaging the z-axis of the nearest points $(-1 + 1)/2 = 0$,  we can get estimate that video is in at-peak phase.
