...
Figure \ref{fig:timetopeak} shows that around three-quarters of a large fraction videos peak within the first six weeks since their upload and beyond six weeks we have uniform distribution.
We also observed that the time-to-peak is exponentially distributed. 
...
\subsection{CDN caching strategy}
As we mentioned in previous sect.\ref{systemdescription}, 


\subsection{Peer caching strategy}
...
\centering
\includegraphics[width=2.5in]{graphs/hit-model-original-1000MB-cdf.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.5in]{graphs/hit-model-original-500MB-cdf.eps}
\end{minipage}\\[-7pt]
\begin{minipage}[t]{.45\linewidth}
\caption{CDF percentage of contribution of peers where peer capacity 500MB.} 
\label{fig:peer500MBcontributionCDN10G}
\end{minipage}%
\hfill%
\begin{minipage}[t]{.45\linewidth}
\caption{CDF percentage of contribution of peers where peer capacity 1000MB.}
\label{fig:peer1000MBcontributionCDN10G}
\end{minipage}%
\vspace{-2mm}
\end{figure*}
...
\begin{minipage}[b]{.45\linewidth}
\centering
\includegraphics[width=2.5in]{graphs/hit-model-original-500MB-replica-10hari-cdf.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.5in]{graphs/hit-model-original-1000MB-replica-10hari-cdf.eps}
\end{minipage}\\[-7pt]
\begin{minipage}[t]{.45\linewidth}
\caption{Replica at t=10day for peer capacity 500MB.} 
\label{fig:peer500MBreplica10dayCDN10G}
\end{minipage}%
\hfill%
\begin{minipage}[t]{.45\linewidth}
\caption{Replica at t=10day for peer capacity 1000MB.}
\label{fig:peer1000MBreplica10dayCDN10G}
\end{minipage}%
\vspace{-2mm}
\end{figure*}
...
\begin{minipage}[b]{.45\linewidth}
\centering
\includegraphics[width=2.5in]{graphs/replica-500MB-10hari.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.5in]{graphs/replica-1000MB-10hari.eps}
\end{minipage}\\[-7pt]
\begin{minipage}[t]{.45\linewidth}
\caption{Replica by popularity at t=10day for peer capacity 500MB.} 
\label{fig:peer1000MBreplica10dayCDN10G}
\end{minipage}%
\hfill%
\begin{minipage}[t]{.45\linewidth}
\caption{Replica by popularity at t=10day for peer capacity 1000MB.}
\label{fig:peer1000MBreplica10dayCDN10G}
\end{minipage}%
\vspace{-2mm}
\end{figure*}
