...
\begin{figure*}[!htb]
\centering
\subfloat[Replica by popularity at t=10day for peer capacity 500MB.\label{fig:peer500MBreplica10dayCDN10Gpopularity}]{
\includegraphics[width=8cm]{graphs/replica-500MB-total-log.eps}
}
\hfill
\subfloat[Replica by popularity at t=10day for peer capacity 1000MB.\label{fig:peer1000MBreplica10dayCDN10Gpopularity}]{
\includegraphics[width=8cm]{graphs/replica-1000MB-total-log.eps}
}
\caption{Peer replica at $t=10$day for peer capacity 500MB and 1000MB.}
...
\begin{figure*}[!htb]
\centering
\subfloat[Replica at t=10day for peer capacity 500MB.\label{fig:peer500MBreplica10dayCDN20G}]{
\includegraphics[width=8cm]{graphs/20G/hit-model-original-500MB-20G-replica-total-cdf-log.eps}
}
\hfill
\subfloat[Replica at t=10day for peer capacity 1000MB.\label{fig:peer1000MBreplica10dayCDN20G}]{
\includegraphics[width=8cm]{graphs/20G/hit-model-original-1000MB-20G-replica-total-cdf-log.eps}
}
\caption{Peer replica at $t=10$day for peer capacity 500MB and 1000MB with CDN capacity 20GB.}
\label{fig:replicaat10day20G}
\vspace{-2mm}
\end{figure*}
...
\begin{figure*}[!htb]
\centering
\subfloat[Replica by popularity at t=10day for peer capacity 500MB and CDN capacity 20GB.\label{fig:peer500MBreplica10dayCDN20Gpopularity}]{
\includegraphics[width=8cm]{graphs/20G/replica-500MB-20G-total-log.eps}
}
\hfill
\subfloat[Replica by popularity at t=10day for peer capacity 1000MB and CDN capacity 20GB.\label{fig:peer1000MBreplica10dayCDN20Gpopularity}]{
\includegraphics[width=8cm]{graphs/20G/replica-1000MB-20G-total-log.eps}
}
\caption{Peer replica at $t=10$day for peer capacity 500MB and 1000MB and CDN capacity 20GB.}
\label{fig:replicaat10daybypopularity20G}
\vspace{-2mm}
\end{figure*}
