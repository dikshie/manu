...
We evaluate three metrics which is peer contribution to delivery contents during simulation,  access frequency of cache during simulation, and number of replicas. 
...
Too many replicas waste the storage resources.
