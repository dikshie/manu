...
Using MLE method, we can get exponential parameter $\lambda = 0.59$ for Borghol et al., work. \\
...
To reveal data distribution of view rate for every video, we plot view rate versus week where we shift week of view rate peak become zero. 
Therefore we can get view rate distribution relative to peak week as shown in fig.~\ref{fig:viewratedistribution}

\begin{figure}[!t]
\begin{center}
\includegraphics[scale=0.6]{graphs/datadistribution.eps}
\end{center}
\caption{View rate distribution versus week where x-axis$=0$ is the peak week for every video.
