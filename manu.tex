...
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:contribu-normala}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-A/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:contribu-shifta}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-A/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:contribu-zipfa}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-A/contributioncdnpeermodelsortedabs.eps}
% }
% \vspace{2mm}
% \caption{Videos rank distribution delivered by peer compared between CPPro and PROP ($y$-axis in log-scale and $y$-axis unit is times) for parameter-A.}
% \label{fig:peercontributiona}
% \end{figure*}
% %%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:atd-normala}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-A/atd.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:atd-shifta}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-A/atd.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:atd-zipfa}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-A/atd.eps}
% }
% \vspace{2mm}
% \caption{Comparison of available replicas between CPPro and PROP when a peer requests a video ($y$-axis in log-scale) for parameter A.}
% \label{fig:replicaa}
% \end{figure*}
% %%%%%
...
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:contribu-normalb}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-B/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:contribu-shiftb}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-B/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:contribu-zipfb}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-B/contributioncdnpeermodelsortedabs.eps}
% }
% \vspace{2mm}
% \caption{Videos rank distribution delivered by peer compared between CPPro and PROP ($y$-axis in log-scale and $y$-axis unit is times) for parameter-B.}
% \label{fig:peercontributionb}
% \end{figure*}
% %%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:atd-normalb}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-B/atd.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:atd-shiftb}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-B/atd.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:atd-zipfb}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-B/atd.eps}
% }
% \vspace{2mm}
% \caption{Comparison of available replicas between CPPro and PROP when a peer requests a video ($y$-axis in log-scale) for parameter B.}
% \label{fig:replicab}
% \end{figure*}
...
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:contribu-normalc}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-C/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:contribu-shiftc}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-C/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:contribu-zipfc}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-C/contributioncdnpeermodelsortedabs.eps}
% }
% \vspace{2mm}
% \caption{Videos rank distribution delivered by peer compared between CPPro and PROP ($y$-axis in log-scale and $y$-axis unit is times) for parameter-C.}
% \label{fig:peercontributionc}
% \end{figure*}
% %%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:atd-normalc}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-C/atd.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:atd-shiftc}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-C/atd.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:atd-zipfc}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-C/atd.eps}
% }
% \vspace{2mm}
% \caption{Comparison of available replicas between CPPro and PROP when a peer requests a video ($y$-axis in log-scale) for parameter C.}
% \label{fig:replicac}
% \end{figure*}
...
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:contribu-normald}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-D/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:contribu-shiftd}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-D/contributioncdnpeermodelsortedabs.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:contribu-zipfd}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-D/contributioncdnpeermodelsortedabs.eps}
% }
% \vspace{2mm}
% \caption{Videos rank distribution delivered by peer compared between CPPro and PROP ($y$-axis in log-scale and $y$-axis unit is times) for parameter-D.}
% \label{fig:peercontributiond}
% \end{figure*}
% %%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \begin{figure*}[!t]
% \centering
% \subfloat[Scenario A.\label{fig:atd-normald}]{
% \includegraphics[width=5.7cm]{graphs/REPLICA/PARAMETER-D/atd.eps}
% }
% \hfill
% \subfloat[Scenario B.\label{fig:atd-shiftd}]{
% \includegraphics[width=5.7cm]{graphs/SHIFT/PARAMETER-D/atd.eps}
% }
% \hfill
% \subfloat[Scenario C.\label{fig:atd-zipfd}]{
% \includegraphics[width=5.7cm]{graphs/ZIPF/PARAMETER-D/atd.eps}
% }
% \vspace{2mm}
% \caption{Comparison of available replicas between CPPro and PROP when a peer requests a video ($y$-axis in log-scale) for parameter D.}
% \label{fig:replicad}
% \end{figure*}
...
%\begin{figure*}[!t]
%\centering
%\subfloat[Scenario A.\label{fig:atd-normal104}]{
%\includegraphics[width=5.7cm]{graphs/new/repl/atd104.eps}
%}
%\hfill
%\subfloat[Scenario B.\label{fig:atd-shift104}]{
%\includegraphics[width=5.7cm]{graphs/new/shift/atd104.eps}
%}
%\hfill
%\vspace{2mm}
%\caption{Comparison of available replicas between CPPro and PROP when a peer requests a video with 100000 peers ($y$-axis in log-scale).}
%\label{fig:replica104}
%\end{figure*}
...
%$u_c$ min is the minimum utility function of a video inside peer's storage.
%}
...
The difference between CPPro and PROP for parameter A,B,C,and D are shown in table \ref{fig:peerdiff}.
...
% \hline
% Scenario & Parameter & Type & Cached (times)& Not-Cached (times) \\ % & Cached (PetaByte) & Not-Cached (PetaByte)\\
% \hline
% A & Parameter A & CPPro &  $48\%$ & $52\%$ \\%& $814.4$ & $1616.6$ \\
% \hline
%  &  & PROP & $68\%$ & $32\%$ \\ %& $1264.1$ & $1166.9$\\
% \hline

% & Parameter B & CPPro & $20\%$ & $80\%$ \\ %& $845.9$ & $1585.1$\\
% \hline
% & & PROP & $72\%$ & $28\%$ \\% &  $1278.7$  &  $1152.3$ \\
% \hline
% %2559751761
% & Parameter C & CPPro & $26\%$ & $74\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $69\%$ & $31\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline

% & Parameter D & CPPro & $27\%$ & $73\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $73\%$ & $27\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline

% B & Parameter A & CPPro &  $15\%$ & $85\%$ \\%& $814.4$ & $1616.6$ \\
% \hline
%  &  & PROP & $68\%$ & $32\%$ \\ %& $1264.1$ & $1166.9$\\
% \hline

% & Parameter B & CPPro & $10\%$ & $90\%$ \\ %& $845.9$ & $1585.1$\\
% \hline
% & & PROP & $72\%$ & $28\%$ \\% &  $1278.7$  &  $1152.3$ \\
% \hline
% %2559751761
% & Parameter C & CPPro & $11\%$ & $89\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $69\%$ & $31\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline

% & Parameter D & CPPro & $15\%$ & $85\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $73\%$ & $27\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline

% C & Parameter A & CPPro &  $30\%$ & $70\%$ \\%& $814.4$ & $1616.6$ \\
% \hline
%  &  & PROP & $66\%$ & $34\%$ \\ %& $1264.1$ & $1166.9$\\
% \hline

% & Parameter B & CPPro & $26\%$ & $74\%$ \\ %& $845.9$ & $1585.1$\\
% \hline
% & & PROP & $71\%$ & $29\%$ \\% &  $1278.7$  &  $1152.3$ \\
% \hline
% %2559751761
% & Parameter C & CPPro & $40\%$ & $60\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $67\%$ & $33\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline

% & Parameter D & CPPro & $30\%$ & $70\%$  \\%& $829.1$ & $1729.9$ \\
% \hline
%  & & PROP & $73\%$ & $27\%$ \\%&  $1732.4$ & $826.6$ \\
% \hline
...
\includegraphics[width=5.7cm]{graphs/NEW5/SCE-A/sce-a.eps}
}
\hfill
\subfloat[Scenario B.\label{fig:cdfutil-shift}]{
\includegraphics[width=5.7cm]{graphs/NEW5/SCE-B/sce-b.eps}
}
\hfill
\subfloat[Scenario C.\label{fig:cdfutil-zipf}]{
\includegraphics[width=5.7cm]{graphs/NEW5/SCE-C/sce-c.eps}
}
\vspace{2mm}
\caption{CDF utility value for scenario A,B,and C.
AA = parameter A, deleted video without $z$, AB = parameter A, deleted video with $z$,  
AC = parameter A, requested video without $z$, AD = parameter A, requested video with $z$,  
BA = parameter B, deleted video without $z$, BB = parameter B, deleted video with $z$,  
BC = parameter B, requested video without $z$, BD = parameter B, requested video with $z$,  
CA = parameter C, deleted video without $z$, CB = parameter C, deleted video with $z$,  
CC = parameter C, requested video without $z$, CD = parameter A, requested video with $z$,  
 }
\label{fig:cdfutil}
\end{figure*}
...
The difference numbers of replicas for scenario A,B,C,D for each parameters are shown in table \ref{fig:replicadiff}.




%Figure~\ref{fig:peercontributions}
