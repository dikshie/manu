...
%The difference between parameter A and B is number of videos while the number of requests are same.
%In parameter B, number of videos are three times number of videos in parameter A.  
F%rom fig.\ref{fig:replicaa} and \ref{fig:replicab}, number of replicas of CPPRO in parameter B converge to PROP earlier than parameter A. 
%This is because three times number of videos available in parameter B compared to parameter A makes a peer can cache 
