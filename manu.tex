...
Peer capacity 1000MB gives higher peer contribution because additional space making peer can cache more videos.
...
\includegraphics[width=8cm]{graphs/hit-model-original-500MB-replica-10hari-cdf.eps}
}
\hfill
\subfloat[Replica at t=10day for peer capacity 1000MB.\label{fig:peer1000MBreplica10dayCDN10G}]{
\includegraphics[width=8cm]{graphs/hit-model-original-1000MB-replica-10hari-cdf.eps}
}
...
\includegraphics[width=8cm]{graphs/replica-500MB-10hari.eps}
}
\hfill
\subfloat[Replica by popularity at t=10day for peer capacity 1000MB.\label{fig:peer1000MBreplica10dayCDN10Gpopularity}]{
\includegraphics[width=8cm]{graphs/replica-1000MB-10hari.eps}
}
\caption{Peer replica at $t=10$day for peer capacity 500MB and 1000MB.}
