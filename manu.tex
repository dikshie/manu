...
\begin{figure*}[!th]
\centering
\subfloat[CDF percentage of contribution of peers where peer capacity 500MB.\label{fig:peer500MBcontributionCDN10G}]{
\includegraphics[width=5.7cm]{graphs/hit-model-original-1000MB-cdf.eps}
}
\hfill
\subfloat[CDF percentage of contribution of peers where peer capacity 1000MB.\label{fig:peer1000MBcontributionCDN10G}]{
\includegraphics[width=5.7cm]{graphs/hit-model-original-500MB-cdf.eps}
}
\hfill
\subfloat[CDF peer contribution percentage between peer with 500MB capacity and 1000MB capacity.\label{fig:peer500MB-vs-1000MBcontributionCDN10G}]{
\includegraphics[width=5.7cm]{graphs/hit-model-500MBvs-1000MB-cdf.eps}
}
\caption{CDF peer contribution for peer capacity 500MB and 1000MB, CDN capacity 10000MB}
...
\label{fig:peer500MBreplica10dayCDN10Gpopularity}
\end{minipage}%
\hfill%
\begin{minipage}[t]{.45\linewidth}
\caption{Replica by popularity at t=10day for peer capacity 1000MB.}
\label{fig:peer1000MBreplica10dayCDN10Gpopularity}
\end{minipage}%
\vspace{-2mm}
\end{figure*}
