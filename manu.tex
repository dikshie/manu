...
We use three scenarios in our simulation which are (1) a peer requests a video that follow Youtube popularity, (2) a peer requests a video that follow Youtube popularity but we shift the request time four weeks, (3) a peer requests a video that based on zipf distribution popularity instead of Youtube.
