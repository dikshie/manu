...
In this paper, we develop a peer-assisted CDN based on previous work. 
Our model is quite different from previous work.  
We add Youtube VoD views popularity aspect to our model. 
From simulation-based experiments driven by real-world Youtube data-sets, we find that peers in our model can contribute to deliver contents higher than previous work on the other hand number of access to cache in peer also higher than previous work.
...
We also examine the characteristics of Internet VoD by investigating real-world data sets obtained from Youtube.
...
%datanya youtube seperti ini.  view bisa dimodelkan dng beta.
...
%memanfaatkan data global seperti borgghol.
%mengapa?
%bagaimana menyatukannya dng datalocal
