...
\begin{figure*}[!ht]
\centering
\subfloat[CDF percentage of contribution of peers where peer capacity 500MB. $x$ and $y$ axis in logscale.\label{fig:peer500MBcontributionCDN10G}]{
\includegraphics[width=5.7cm]{graphs/hit-model-original-1000MB-cdf-log.eps}
}
\hfill
\subfloat[CDF percentage of contribution of peers where peer capacity 1000MB. $x$ and $y$ axis in logscale.\label{fig:peer1000MBcontributionCDN10G}]{
