...
We want to know what makes replica of CPPro is lower than PROP.
For this purpose, we breakdown how many cache events occur in our simulation as shown in table.\ref{tab:stacked1}.
When a peer requests a video to another peer, a peer has to decide whether a peer wants to cache the video or not to cache the video based on the utility function.  
...
However, by summing data volume for cached events and no-cached events, CPPro can deliver or contribute of videos delivery more than PROP. 
